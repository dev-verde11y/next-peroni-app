        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center space-x-4 mb-6">
              {/* Logo placeholder - mesmo do header */}
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-4 max-w-md leading-relaxed">
              Especialista em Direito Civil, Trabalhista e Empresarial com mais de 15 anos de experiência. 
              Soluções jurídicas personalizadas e resultados eficazes.
            </p>
            
            <div className="space-y-2 text-sm text-gray-500 dark:text-gray-400">
              <p><span className="font-semibold">OAB/SP:</span> 123.456</p>
            ...
            <div className="flex space-x-4 mt-6">
              <a 
                href="#" 
                className="w-10 h-10 bg-white dark:bg-gray-800 rounded-xl flex items-center justify-center text-gray-600 dark:text-gray-300 hover:text-amber-600 dark:hover:text-amber-400 hover:bg-amber-50 dark:hover:bg-amber-900/20 transition-all duration-300 shadow-sm hover:shadow-md group"
                aria-label="LinkedIn"
              >
          ...
          {/* Links rápidos */}
          <div>
            <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-6">Links Rápidos</h4>
            <ul className="space-y-3">
              {[
                ...
                <li key={item.name}>
                  <Link 
                    href={item.href} 
                    className="text-gray-600 dark:text-gray-300 hover:text-amber-600 dark:hover:text-amber-400 transition-colors duration-300 flex items-center group"
                  >
          ...
          {/* Contato */}
          <div>
            <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-6">Contato</h4>
            <div className="space-y-4">
              <div className="flex items-center space-x-3 group">
                <div className="w-8 h-8 bg-amber-100 dark:bg-amber-900/30 rounded-lg flex items-center justify-center group-hover:bg-amber-200 dark:group-hover:bg-amber-900/50 transition-colors duration-300">
                ...
                <div>
                  ...
                  <p className="text-gray-900 dark:text-white font-medium">(11) 9999-9999</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3 group">
                ...
                <div>
                  ...
                  <p className="text-gray-900 dark:text-white font-medium">contato@hicaperoni.com.br</p>
                </div>
              </div>
            ...
            <div className="mt-6">
              <Link
                href="/contato"
                className="inline-flex items-center justify-center w-full px-4 py-2.5 bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white font-semibold rounded-xl shadow-sm hover:shadow-md transform hover:-translate-y-0.5 transition-all duration-300"
              >
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-gray-500 dark:text-gray-400 text-sm text-center md:text-left">
              &copy; 2025 <span className="font-semibold">Hiça Peroni Advocacia</span>. Todos os direitos reservados.
            </p>
            <div className="flex space-x-6 text-sm">
              <Link href="/privacidade" className="text-gray-500 dark:text-gray-400 hover:text-amber-600 dark:hover:text-amber-400 transition-colors duration-300">
                Política de Privacidade
              </Link>
              <Link href="/termos" className="text-gray-500 dark:text-gray-400 hover:text-amber-600 dark:hover:text-amber-400 transition-colors duration-300">
                Termos de Uso
              </Link>
            </div>
          </div>
